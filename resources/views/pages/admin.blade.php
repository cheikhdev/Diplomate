        ...
        <div class="card w-75 mt-5">
            ...
            <div class="card-body">
                <form class="" method="POST" action="{{route('login')}}">
					...
					<button type="button" class="" data-dismiss="modal" style="border-radius:70px;width:150px;height:35px;size:12px;font-weight:bold;background:#BE1E2D;">Close</button>
					<button class="" style="border-radius:70px;width:150px;height:35px;size:12px;font-weight:bold;background:#191348;">Se Connecter</button>
				</form>
            </div>
        </div>
    </div>
